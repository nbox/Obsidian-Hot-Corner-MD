...
- Scroll to the **Security** section. You should see a message that `ObsidianHotCornerMD.app` was blocked.
- Click **Open Anyway**, then confirm in the dialog by choosing **Open Anyway** again.
